...
export const AtualizarCliente = (props) => {
    ...
    const getCliente = async () => {
        await axios.get(api + "/clientes/" + ClienteId).then((response) => {
            setCliente(response.data.clnt);
        }).catch(() => {
            setStatus({
                type: "error",
    ...
    const atualizar = async e => {
        ...
        await axios.put(api + "/clientes/" + ClienteId + "/atualizarcliente", cliente, { headers }).then((response) => {
            setStatus({
                type: "success",
